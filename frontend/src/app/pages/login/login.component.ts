...
export class LoginComponent implements OnInit, AfterViewInit {
  ...
  constructor(private translate: TranslateService, private managerService: ManagerService, private router: Router, private activatedRoute: ActivatedRoute) {
  ...
  form: AppForm[] = [
    { htmlFor: "email", type: "email", placeholder: "LOGIN.EMAIL", title: "LOGIN.EMAIL", model: this.manager, name: "email" },
    { htmlFor: "password", type: "password", placeholder: "LOGIN.PASSWORD", title: "LOGIN.PASSWORD", model: this.manager, name: "password" },
  ]
    ...
    this.managerService.login(this.manager).subscribe(manager => {
      ...
      if (error.status === 0) {
        ...
        Swal.fire({
          ...
          text: this.translate.instant("LOGIN.ERROR.UNAUTHORIZED.DESCRIPTION"),
          background: "#dc3545",
          ...this.toastOptions
        })
      }
